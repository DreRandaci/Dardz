...
export const Instructions = () => (
  <CustomText fontSize={18}>
    ...
    <Br />
    <Br />
    <Bold fontSize={20}>OVERVIEW</Bold>
    <Br />
    <Br />
    ...
    <Bold fontSize={20}>CONTENTS</Bold>
    <Br />
    <Br />
    DARDZ consists of 3 dice and 90 cards. There are 6 of each number 1-12, and 3 of all 6 action cards. Each card has a point value listed at the bottom the card. (See card layout images.)
    <Br />
    <Br />

    <Bold fontSize={20}>GAME SET UP</Bold>
    <Br />
    <Br />
    ...
    <Bold fontSize={20}>HOW TO PLAY</Bold>
    <Br />
    <Br />
    ...
    <CustomText fontSize={18}>EACH TURN:</CustomText>
    <Br />
    <Br />
    ...
    <CustomText fontSize={18}>EACH ROUND:</CustomText>
    <Br />
    <Br />
    ...
    <Bold fontSize={20}>KEEPING SCORE</Bold>
    <Br />
    <Br />
    ...
    <CustomText fontSize={18}>6 WAYS TO SCORE POINTS:</CustomText>
    <Br />
    <Br />
    ...
    <Bold fontSize={20}>STRATEGY</Bold>
    <Br />
    <Br />
...
export const QuestionsAndRules = () => (
  <CustomText fontSize={18}>
    ...
    <Br />
    <Br />
    <CustomText fontSize={20}>ACTION CARDS:</CustomText>
    <Br />
    <Br />
    ...
    <Br />
    <Br />
    <CustomText fontSize={20}>BONUS ROLL:</CustomText>
    <Br />
    <Br />
    ...
    <CustomText fontSize={20}>DRAW PILE:</CustomText>
    <Br />
    <Br />
...
and nobody gets the +10 points.
    ...
    <CustomText fontSize={20}>POINTS PILE:</CustomText>
    <Br />
    <Br />
    ...
    <CustomText fontSize={20}>ROLLS:</CustomText>
    <Br />
    <Br />
...
matches what’s in your hand.
    ...
    <CustomText fontSize={20}>RULES:</CustomText>
    <Br />
    <Br />
...
add it to your points pile.
    ...
    <CustomText fontSize={20}>SCORING & WINNING:</CustomText>
    <Br />
    <Br />
  ...
  ty of rolling that number.
    ...
    <CustomText fontSize={20}>3-OF-A-KIND:</CustomText>
    <Br />
    <Br />
